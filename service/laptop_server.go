...
func (server *LaptopServer) SearchLaptop(
	...
	log.Printf("recevie a search-laptop request with filter: %v", filter)
...
func (server *LaptopServer) UploadImage(stream pb.LaptopService_UploadImageServer) error {
	...
	log.Printf("recevie an upload-image request for laptop %s with image type %s", laptopID, imageType)
	...
	for {
		...
		log.Print("waiting to recevie more data")
