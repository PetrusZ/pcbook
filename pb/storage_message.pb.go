...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=petrus.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x70, 0x65, 0x74, 0x72, 0x75, 0x73, 0x2e,
	...
	0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x70, 0x65, 0x74, 0x72, 0x75,
	...
	0x15, 0x2e, 0x70, 0x65, 0x74, 0x72, 0x75, 0x73, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: petrus.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: petrus.pcbook.Storage
	(*Memory)(nil),      // 2: petrus.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: petrus.pcbook.Storage.driver:type_name -> petrus.pcbook.Storage.Driver
	2, // 1: petrus.pcbook.Storage.memory:type_name -> petrus.pcbook.Memory
