...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=petrus.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x20, 0x2e, 0x70, 0x65, 0x74, 0x72, 0x75, 0x73, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f,
	...
	0x2e, 0x70, 0x65, 0x74, 0x72, 0x75, 0x73, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: petrus.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: petrus.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: petrus.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: petrus.pcbook.Screen.resolution:type_name -> petrus.pcbook.Screen.Resolution
	0, // 1: petrus.pcbook.Screen.panel:type_name -> petrus.pcbook.Screen.Panel
