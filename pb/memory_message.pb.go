...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=petrus.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x70, 0x65, 0x74, 0x72, 0x75, 0x73, 0x2e, 0x70, 0x63,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: petrus.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: petrus.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: petrus.pcbook.Memory.unit:type_name -> petrus.pcbook.Memory.Unit
